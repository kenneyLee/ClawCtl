...
export interface InstanceInfo {
  ...
  sessions: { key: string; kind: string; model?: string; displayName?: string; alias?: string; channel?: string; updatedAt?: number; inputTokens?: number; outputTokens?: number; totalTokens?: number; cacheReadTokens?: number; cacheWriteTokens?: number }[];
